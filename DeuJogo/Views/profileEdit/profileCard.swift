...
//  DeuJogo
//
//  Created by Turma02-11 on 20/03/24.
//
...
struct profileCard: View {
    ...
    var body: some View {
        ...
        VStack{
            ...
            VStack{
                ZStack{
                    AsyncImage(url: URL(string: usuFake.avatar)) { image in
                        image.resizable()
...
#Preview {
    profileCard(usuFake : userFake(id: 1, nome: "fulano" , avatar: "kk", telefone: "3i4u348", modalidades: "fut"))
}
